...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER0] = LAYOUT(KC_ESC,  KC_F1,      KC_F2,      KC_F3,         KC_F4,      KC_F5,       KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,          KC_PSCR, KC_SCRL, KC_PAUS,
                       ...
                       KC_LCTL, KC_A,       KC_S,       KC_D,          KC_F,       KC_G,        KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_DQUO,    RCTL_T(KC_ENT),  KC_VOLD,
    ...
    [_LAYER2] = LAYOUT(RGB_TOG, KC_P1,      KC_P2,      KC_P3,         KC_P4,      KC_P5,       KC_P6,      KC_P7,     KC_P8,      KC_P9,      KC_P0,      KC_PAST,    KC_PPLS,         RGB_SPI, RGB_SPD, KC_TRNS,
                       KC_TRNS, KC_TRNS,    KC_TRNS,    KC_TRNS,       KC_END,    KC_TRNS,     KC_HOME,    KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_TRNS,    KC_PMNS,    KC_PEQL,         KC_DEL,  RGB_VAD, KC_TRNS,
                       KC_BTN2, KC_WH_U,    KC_BTN1,    KC_MS_U,  LSFT(KC_INS),   KC_TRNS,     KC_DOWN,    KC_RIGHT,   KC_PGUP,    LCTL(KC_INS),KC_TRNS,    KC_TRNS,    KC_TRNS,         KC_TRNS, KC_MPRV,
                       KC_TRNS, KC_WH_D,    KC_MS_L,    KC_MS_D,       KC_MS_R,    KC_TRNS,     KC_TRNS,    KC_TRNS,   KC_TRNS,    KC_INS,     KC_TRNS,    KC_TRNS,    KC_TRNS,         KC_MNXT,
                       KC_TRNS, KC_TRNS,    KC_TRNS,    LCTL(KC_X),    KC_PGDN,    KC_TRNS,     KC_NO,      KC_UP,     KC_LEFT,    KC_PCMM,    KC_PDOT,    KC_PSLS,    KC_TRNS,         KC_TRNS, KC_MRWD,
...
const key_override_t double_quote_map = ko_make_basic(MOD_MASK_SHIFT, KC_DQUO, KC_QUOT);
